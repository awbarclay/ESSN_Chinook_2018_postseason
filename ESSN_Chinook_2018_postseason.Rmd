...
#save.image("V:/Analysis/2_Central/Chinook/Cook Inlet/2014/Mixture/2015_ESSN_Chinook_redo/2015_ESSN_Chinook_redo.Rdata")

load("V:/Analysis/2_Central/Chinook/Cook Inlet/2014/Mixture/2015_ESSN_Chinook_redo/2015_ESSN_Chinook_redo.Rdata")
...
####BAYES mixture files
```{r create mixture input files,echo=FALSE}

for(mix in mixtures){
  
  mixfortan<-CreateMixture.GCL(sillys = mix,loci=loci,mixname=mix,dir="BAYES/mixture")
...
mix.in<-create_rubias_mixture(mixtures=mixtures)
